...
public void createSheet() {
	...
	boolean link=driver.findElement(By.xpath("(//a[text()='Go to Google Drive'])[2]")).isDisplayed();
	Assert.assertTrue(true,"Not displayed");
	
	//Assert.assertSame("Go to Google Drive","link","Not same");
	//	if(flaggd==true)
//	{
...
//}
//
//boolean pswchk=driver.findElement(By.name("password")).;
//
//if(pswchk==true) 
//{
...
//Thread.sleep(5000);
//
//boolean flgdc=driver.findElement(By.xpath("(//div[@class='h-v-x'])[5]")).isEnabled();
//if(flgdc==true) 
//{
...
//}
//
//WebElement newdoc=driver.findElement(By.xpath("(//div[@class='h-v-x'])[5]"));
...
// 
// 
// WebElement shfile=driver.findElement(By.xpath("//input[@aria-label='Rename']"));
// shfile.click();
// shfile.clear();
//Thread.sleep(3000);
//shfile.sendKeys(" saikiran sheet");
//shfile.sendKeys(Keys.ENTER);
//
//
